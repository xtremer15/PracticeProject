...
const RENDERED_JS_DOM_ELEMENTS = {
  a: createElement("a", "class", "dropdown"),
  ul: createElement("ul", "class", "container"),
};
...
for (elem in subMenuDevelopers) {
  ...
  RENDERED_JS_DOM_ELEMENTS.a.innerHTML = subMenuDevelopers[elem];
  RENDERED_JS_DOM_ELEMENTS.ul.appendChild(a);
}
DOM_SELECTED_ELEMENTS.ul.appendChild(ul);
